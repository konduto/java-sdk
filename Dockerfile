# 1. Base com Java 11 (Necessário para rodar o Gradle >+ 5.0 < or equal 8.14)
...
# 3. Instalação de ferramentas básicas e do Java 11 (para seu código legado)
...
# 4. Instalação SDKman e Gradle 8.14
